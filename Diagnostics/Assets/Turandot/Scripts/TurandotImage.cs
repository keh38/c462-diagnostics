...
namespace Turandot.Scripts
{
    public class TurandotImage : TurandotCue
    {
        ...
        public override void Activate(Cue cue)
        {
            ...
            //int x = image.X;
            //if (image.horizontalAlignment == ImageAction.HorizontalAlignment.Left)
            //    x += width / 2;
            //else if (image.horizontalAlignment == ImageAction.HorizontalAlignment.Right)
            //    x -= width / 2;

            //int y = image.Y;
            //if (image.verticalAlignment == ImageAction.VerticalAlignment.Top)
            //    y -= height / 2;
            //else if (image.verticalAlignment == ImageAction.VerticalAlignment.Bottom)
            //    y += height / 2;
        ...
        {
            if (_imageAction != null && _imageAction.EndVisible)
            {
